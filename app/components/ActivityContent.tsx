...
export default function ActivityContent() {
    ...
    return (
        <div className='flex flex-col justify-center items-center gap-8 h-full'>
            <img src="/Call/iconsax-mouse-square.svg" alt="" className="w-7 h-7" />
            <div className='flex flex-col gap-3'>
                <h2 className='text-dark text-xl font-semibold text-center'>Waiting for partner</h2>
                <p className='text-dark-50 text-sm font-normal text-center'>Your partner is choosing<br />an activity to begin.</p>
            </div>
        </div>
    );
}
